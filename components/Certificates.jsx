  ...
  return (
    <div className="w-full lg:h-screen p-3">
      <div className="max-w-[1240px] mx-auto flex-col justify-center h-full">
        ...
        <h2 className="py-2">Certificate Of Knowledge</h2>
        <div className="grid lg:grid-cols-2 gap-8">
          <Link href="https://certificates.soyhenry.com/cert?id=a371a88c-e6f7-4e4b-8b5e-fbfbbdffa1ae">
            <div className="p-2 shadow-xl shadow-gray-400 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="grid grid-cols-2 gap-2 justify-center items-center">
                ...
                <div className="flex flex-col items-center justify-center">
                  <p className="text-md mb-2 mr-1">FULL STACK DEVELOPER</p>
            ...
            <div className="p-2 shadow-xl shadow-gray-400 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="grid grid-cols-2 gap-2 justify-center items-center">
                ...
                <div className="flex flex-col items-center justify-center mb-9">
                  <p className="mb-6 text-md mr-7">JS INTERMEDIATE</p>
                  <p className="text-sm p-1 py-2 text-gray-600">
          ...
          <Link href="https://www.hackerrank.com/certificates/7fec95b2f4d7">
            <div className="p-2 shadow-xl shadow-gray-400 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="grid grid-cols-2 gap-2 justify-center items-center">
                ...
                <div className="flex flex-col items-center justify-center mb-9">
                  <p className="mb-8 text-md mr-7">REST API INTERMEDIATE</p>
                  <p className="text-sm p-1 py-2 text-gray-600">
            ...
            <div className="p-2 shadow-xl shadow-gray-400 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="grid grid-cols-2 gap-2 justify-center items-center">
                ...
                <div className="flex flex-col items-center justify-center mb-6">
                  <p className="mb-8 text-md mr-7">NODE BASIC</p>
                  <p className="text-sm p-1 py-2 text-gray-600">
          ...
          <Link href="https://www.hackerrank.com/certificates/ffd868b957d6">
            <div className="p-2 shadow-xl shadow-gray-400 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="grid grid-cols-2 gap-2 justify-center items-center">
                ...
                <div className="flex flex-col items-center justify-center mb-9">
                  <p className="mb-10 text-md mr-7">SQL BASIC</p>
            ...
            <div className="p-2 shadow-xl shadow-gray-400 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="grid grid-cols-2 gap-2 justify-center items-center">
                ...
                <div className="flex flex-col items-center justify-center mb-5">
                  <p className="mb-5 text-md mr-7">REACT BASIC</p>
                  <p className="text-sm  text-gray-600">
          ...
          <Link href="https://www.hackerrank.com/certificates/861970b4131e">
            <div className="p-2 shadow-xl shadow-gray-400 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="grid grid-cols-2 gap-2 justify-center items-center">
                ...
                <div className="flex flex-col items-center justify-center mb-5">
                  <p className="mb-5 text-md mr-7">CSS</p>
                  <p className="text-sm  text-gray-600">
          ...
          <Link href="https://www.hackerrank.com/certificates/7a2397df0f44">
            <div className="p-2 shadow-xl shadow-gray-400 rounded-xl hover:scale-105 ease-in duration-300">
              <div className="grid grid-cols-2 gap-2 justify-center items-center">
                ...
                <div className="flex flex-col items-center justify-center mb-5">
                  <p className="mb-5 text-md mr-7">PROBLEM SOLVING BASIC</p>
                  <p className="text-sm  text-gray-600">
                    It covers basic topics of Data Structures (such as Arrays,
                    Strings) and Algorithms (such as Sorting and Searching).
                  </p>
                </div>
              </div>
            </div>
